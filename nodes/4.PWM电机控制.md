...
1.需要电机驱动芯片DRV8833PWPR,电机不能直接接stm32管脚，管脚电平较低，无法驱动电机，需要通过驱动芯片，输出电机需要的电压进行控制

2.硬件中，四个电机两个分组，每组两个电机串联，同时驱动，即，两路输出，每路控制一组电机转动，一组电机转动方式相同

![图片描述](https://img.mukewang.com/wiki/6401cbb909f8cbd312461280.jpg)
...
- 该器件**利用故障输出引脚实现内部关断功能**，提供过流保护、短路保护、欠压锁定和过热保护。另外，还提供了一种低功耗休眠模式。
...
![图片描述](https://img.mukewang.com/wiki/6401cbcb091d9da012800774.jpg)
...
![图片描述](https://img.mukewang.com/wiki/6401cbe90953259212800782.jpg)

![图片描述](https://img.mukewang.com/wiki/6401cbf6099605fd12800710.jpg)

#### 控制电机刹车

![图片描述](https://img.mukewang.com/wiki/6401cc050999e42d12800789.jpg)
...
![图片描述](https://img.mukewang.com/wiki/6401cc15092943b608000398.jpg)
...
![图片描述](https://img.mukewang.com/wiki/6401cc2409a04f8408000386.jpg)
...
![图片描述](https://img.mukewang.com/wiki/6401cc3309c618c010810650.jpg)

#### 伺服电机

伺服电机是一个**旋转致动器或线性致动器，其允许角速度或线的位置，速度和加速度的精确控制**。
...
![图片描述](https://img.mukewang.com/wiki/6401cc5409163d6012571029.jpg)

![图片描述](https://img.mukewang.com/wiki/6401cc6009f39b8312600959.jpg)
...
![图片描述](https://img.mukewang.com/wiki/6401cc7509b9601909470308.jpg)
...
> 这称为再循环电流。为了处理这种再循环电流，H桥可以在两种不同的状态下运行：快衰减或慢衰减。在快衰减模式下，H桥被禁用，再循环电流流过体二极管；在慢衰减模式下，电机绕组短路。
...
> 对于使用快速衰减的PWM，PWM信号施加到一个xIN引脚，而另一个保持为低电平；要使用慢速衰减，一个xIN引脚保持为高电平。

![图片描述](https://img.mukewang.com/wiki/6401cc8b09193eaf09660268.jpg)
...
![图片描述](https://img.mukewang.com/wiki/6401cc9b09ef711508500470.jpg)
...
- 控制直流电机时，**在快衰减模式下**，由于电流迅速下降，那么电感电机上**储存的能量就会释放很慢**,电机会逐渐停止，因此该模式又叫**滑动**； 
